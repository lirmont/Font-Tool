...
{
	private bool DrawNothing = false;
	...
	{
		// If the control is in design mode, treat it as though it were fixed at 15 pixels width.
		if (DrawNothing)
			return new Size(15, constrainingSize.Height);
