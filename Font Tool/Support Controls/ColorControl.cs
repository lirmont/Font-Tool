...
namespace ColorControl
{
	public partial class ColorControl : Form
	{
		...
		private void simpleOpenGlControl_Resize(object sender, EventArgs e)
		{
			...
			GL.LoadIdentity();
			GL.ClearColor(this.BackColor.R / 255.0f, this.BackColor.G / 255.0f, this.BackColor.B / 255.0f, 0);
		...
		private void helpButton_Click(object sender, EventArgs e)
		{
			...
			if (!File.Exists(helpTemporaryFile))
				File.WriteAllBytes(helpTemporaryFile, FontTool.Properties.Resources.ColorControlDocumentation);
