...
namespace ColorControl
{
	public static class SupportFunctions
	{
		...
		/// </summary>
		/// <param name="blend">Abstracted name of blending mode. Intentionally avoid functionality after OpenGL 1.1.</param>
				...
				if (outline != null)
				{
					...
					GL.Begin(BeginMode.LineStrip);
					{
						for (int i = 0; i < vertexCount + 1; i++)
						{
							...
							GL.Vertex2(circle.x + k, circle.y - h);
						}
					}
					GL.End();
				}
