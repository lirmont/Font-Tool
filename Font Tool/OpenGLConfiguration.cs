...
namespace FontTool
{
	public class OpenGLConfiguration
	{
		...
		public bool BufferedDataIsSupported
		{
			get { return bufferedDataIsSupported; }
			set { bufferedDataIsSupported = value; }
		}

		// Queried. Default: oldest Windows production.
		...
		// glBindBuffer, glBufferData at 1.5
		private bool bufferedDataIsSupported = false;
		// Derived.
		...
		private void reloadAbilities()
		{
			...
			// Bind Buffer, Buffer Data < 1.5
			bufferedDataIsSupported = (majorVersion > 1 || (majorVersion == 1 && minorVersion >= 5)) ? true : false;
		}
	}
}
