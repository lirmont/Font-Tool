...
{
	public partial class relativeTimePattern
	{
		private relativeTimePatternCount countField;
		private relativeTimePatternDraft draftField;
		...
		public relativeTimePatternCount count
		{
			get { return this.countField; }
			set { this.countField = value; }
		}
		[System.Xml.Serialization.XmlAttributeAttribute()]
		public relativeTimePatternDraft draft
		{
